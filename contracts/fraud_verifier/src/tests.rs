...
fn test_expired_challenge_window_rejected() {
    ...
    env.as_contract(&contract_id, || {
        env.storage()
            .instance()
            .extend_ttl(future_seq + 100_000, future_seq + 100_000);
    ...
    let result = client.try_submit_fraud_proof(&challenger, &300u32, &0u32, &commitment, &proof);
