...
### Layer 3: Frontend & Client SDK (`frontend/`, `frontend-vanilla/`, `sdk/js/`) — **Low to Medium**
...
- *Note*: The frontend does not handle or store user private key material directly; wallet interactions are delegated to external Stellar wallet providers (e.g. Freighter).
