...
export const FreighterInstallModal: React.FC<FreighterInstallModalProps> = ({ error, onDismiss }) => {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Title & Description */}
        <h3 style={{ fontSize: '20px', fontWeight: '800', color: '#0f172a', margin: '0 0 8px 0', letterSpacing: '-0.02em' }}>
          Freighter Extension Needed
        </h3>
        <p style={{ fontSize: '13.5px', color: '#64748b', margin: '0 0 22px 0', lineHeight: '1.5' }}>
          To sign Soroban transactions on Pactum, please install the official Stellar Freighter browser extension.
        </p>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '12.5px', color: '#334155', fontWeight: '600' }}>
