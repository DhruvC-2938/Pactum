    ...
    <div className="landing">
      ...
      <section className="lp-hero">
        ...
        <h1 className="lp-hero-title">
          On-chain registry
          <br />
          <span className="lp-hero-accent">for commitments</span>
          <br />
          that matter.
        </h1>
        ...
        <div className="lp-hero-actions">
          ...
          <button className="lp-btn-ghost lp-btn-lg" onClick={onOpenDocs}>
            Read the Docs
          </button>
        </div>
      ...
      <section className="lp-stats">
        <div className="lp-stat">
          ...
          <div className="lp-stat-label">Commitments on-chain</div>
        </div>
        <div className="lp-stat-divider"></div>
        <div className="lp-stat">
          <div className="lp-stat-value">7d</div>
          <div className="lp-stat-label">Dispute window</div>
        </div>
        <div className="lp-stat-divider"></div>
        <div className="lp-stat">
          <div className="lp-stat-value">0</div>
          <div className="lp-stat-label">Funds held</div>
        </div>
        <div className="lp-stat-divider"></div>
        <div className="lp-stat">
          <div className="lp-stat-value">∞</div>
          <div className="lp-stat-label">Addresses queryable</div>
        </div>
      </section>
          ...
          {[
            {
              n: '01',
              t: 'Create',
              d: 'Either party registers the commitment on-chain: issuer, counterparty, terms hash, and due date. Immutable from this point.',
            },
            {
              n: '02',
              t: 'Attest',
              d: 'After the due date, the issuer or counterparty records the outcome: Fulfilled, Late, or Breached.',
            },
            {
              n: '03',
              t: 'Dispute',
              d: 'If parties disagree, a 7-day window allows a dispute to be raised. A designated arbitrator then resolves it.',
            },
            {
              n: '04',
              t: 'Reputation',
              d: "Every resolved outcome feeds the issuer's on-chain reputation score — a permanent, verifiable compliance record.",
            },
          ].map((s, i) => (
      ...
      <footer className="lp-footer">
        <div className="lp-footer-copy">© 2026 Pactum Protocol. Built on Soroban / Stellar.</div>
      </footer>
    </div>
  );
}
